...
export const GROUPS_WITHOUT_SUBSYSTEM_PAGE: Readonly<Record<string, string>> = {
  ...
  cloudflare: 'Deployable Worker/Durable-Object glue with no Cordis-facing type or service contract of its own; the storage and session subsystem pages own the D1-backed contracts it starts.',
