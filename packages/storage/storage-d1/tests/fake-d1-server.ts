 ...
 * D1 database. Kept at package level under `tests/` per this repo's test
 * layout, not shipped in `src/`.
 * @module
 */
...
export class FakeD1Server {
  ...
  /** Run one statement's failure mode for the next matching call, for network/malformed-response tests. */
