...
| [`session-persistence-d1/`](session-persistence-d1/README.md) | Opt-in backend: every session's log in one Cloudflare D1 database, reached over D1's REST API | registers on `ctx.sessionPersistence` |
