---
description: "Shared OpenUI Lang component vocabulary consumed by the server-side render_ui tool and the web chat renderer, so the taught grammar, validator, and drawable component set cannot drift apart."
